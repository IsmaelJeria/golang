...
func main() {
	...
	templates := template.Must(template.ParseFiles("templates/openmangago-template.html"))
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		if err := templates.ExecuteTemplate(w, "openmangago-template.html", welcome); err != nil {
